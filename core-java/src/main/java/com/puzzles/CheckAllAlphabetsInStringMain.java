 ...
 *
 * https://howtodoinjava.com/puzzles/puzzle-check-if-string-is-complete-contains-all-alphabets/
 *
 * @author Srinath.Rayabarapu
 */
public class CheckAllAlphabetsInStringMain {
    ...
    private static String checkAllChars(String input) {
        ...
        for (char ch = 'A'; ch <= 'Z'; ch++) {
            // check index of small and upper chars
